...
void main() {
    ...
    {
		float depth = texture(depth_texture, o_texture_coord).x; // TODO access the depth component of your FBO
	...
	else if (filter_mode == 2)
	{
		...
		float depth = texture(depth_texture, o_texture_coord).x; // TODO access the depth component of your FBO
		gl_FragDepth = depth; // set it to gl s.t. the scene annotation is reserved
	}
